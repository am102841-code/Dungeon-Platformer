...
# store points as a variable so the points does not reset to 0 after each level ends
...
# TO DO LIST
'''
- add one more character - maybe a witch, slime, werewolf, etc
- fix the player when it first comes into the game 
the skin is a knight, even if other skins are selected
- make more levels 
- moving platforms
- enemies 
- make character menu better looking
- make game menu better looking 
- make a button during gameplay to save progress or go back to menu 
- settings button for audio volume, etc 
- use json to save data in files to save progress 
- use matplot lib to create data graphs based on gameplay 
[jumps, coins collected, etc] 
- animation for sprites 
- getting the game onto itch.io 
'''
...
cutscene_texts = ["For enternities his dungeon has trapped those dare enter...",
                  "Many have tried to escape... none have succeeded.",
                  "Stones rise without warning. Spikes lie on baren platforms. Only the clever survive.",
                  "Your goal is simple: escape... if you can"
                  ]
current_panel = 0
...
ruins = pygame.image.load('ruins.png')
ruins = pygame.transform.scale(ruins, (150, 150))
...
class DungeonButton():
    def __init__(self, x, y, width, height, text):
        ...
        self.base_color = (58, 44, 34)
        self.hover_color = (110, 85, 60)
        self.pressed_color = (40, 30, 24)
        self.border_color = (150, 120, 80)
        self.text_color = (235, 220, 190)
        self.glow_color = (255, 200, 120)
        self.border_width = 3
    ...
    def draw(self, surface):
        ...
        # Button body
        pygame.draw.rect(surface, color, draw_rect, border_radius=self.corner_radius)

        # Border
        pygame.draw.rect(surface, self.border_color, draw_rect, self.border_width, border_radius=self.corner_radius)

        # Glow effect
        if self.hovered and self.enabled:
            glow = pygame.Surface((self.rect.width, self.rect.height), pygame.SRCALPHA)
            pygame.draw.rect(glow, (*self.glow_color, 60), glow.get_rect(), border_radius=self.corner_radius)
...
start_button = DungeonButton(300, 260, 200, 60, "Start")
creator_button = DungeonButton(300, 340, 200, 60, "Creator")
tutorial_button = DungeonButton(300, 420, 200, 60, "Tutorial")
characters_button = DungeonButton(300, 500, 200, 60, "Characters")

menu_buttons = [start_button, creator_button, tutorial_button, characters_button]
...
def main():
    ...
    while looping:
        ...
        if game_state == 'gameMenu':
            ...
            PlatformerText = fontObj.render("Dungeon Platformer", True, GREY)
            ...
            for event in pygame.event.get():
                ...
                if creator_button.handle_event(event):
                    game_state = 'creator'
                ...
                if characters_button.handle_event(event):
                    game_state = 'skins'

            start_button.update(mouse_pos)
            creator_button.update(mouse_pos)
            tutorial_button.update(mouse_pos)
            characters_button.update(mouse_pos)

            start_button.draw(WINDOW)
            creator_button.draw(WINDOW)
            tutorial_button.draw(WINDOW)
            characters_button.draw(WINDOW)
            ...
            if showMessage:
                ...
                if elapsed < 2500:
                    ...
                    WINDOW.blit(fontobj.render(msg, True, (255, 255, 255)), (300 - 150, 300 - 150))
                else:
                    showMessage = False
            ...
            if showMessage2:
                ...
                if elapsed2 < 2500:
                    ...
                    WINDOW.blit(fontobj.render(msg2, True, (255, 255, 255)), (300 - 150, 300 - 150))
                else:
                    showMessage2 = False
            ...
            menu_jump_timer += 1
            if menu_jump_timer > 35 and menu_on_ground:
                menu_y_speed = -15
        ...
        # Creator Page
            ...
            if level == 2 and level_changing:
                ...
                # obstacles
                ob2 = pygame.Rect(565 - 200, 270+40, 100, 40)
